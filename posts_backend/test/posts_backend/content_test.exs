defmodule PostsBackend.ContentTest do
  use PostsBackend.DataCase

  alias PostsBackend.Content

  describe "posts" do
    alias PostsBackend.Content.Post

    @valid_attrs %{body: "some body", published_at: "2010-04-17T14:00:00Z", status: "some status", title: "some title"}
    @update_attrs %{body: "some updated body", published_at: "2011-05-18T15:01:01Z", status: "some updated status", title: "some updated title"}
    @invalid_attrs %{body: nil, published_at: nil, status: nil, title: nil}
